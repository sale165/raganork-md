...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~71871471fe85f275568f756ceb4ad5dc:656c4244305770794d67733d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    MANGLISH_CHATBOT: convertToBool(process.env.MANGLISH_CHATBOT) || ture,
    ADMIN_ACCESS: convertToBool(process.env.ADMIN_ACCESS) || ture,
    ...
    MULTI_HANDLERS: convertToBool(process.env.MULTI_HANDLERS) || ture,
    DISABLE_START_MESSAGE: convertToBool(process.env.DISABLE_START_MESSAGE) || ture,
    ...
    AUTO_READ_STATUS: convertToBool(process.env.AUTO_READ_STATUS) || ture,
    READ_MESSAGES: convertToBool(process.env.READ_MESSAGES) || ture,
    PMB_VAR: convertToBool(process.env.PMB_VAR) || ture,
    DIS_PM: convertToBool(process.env.DIS_PM) || ture,
    REJECT_CALLS: convertToBool(process.env.REJECT_CALLS) || ture,
    PMB: process.env.PMB || '_Personal messages not allowed, BLOCKED!_',
    READ_COMMAND: convertToBool(process.env.READ_COMMAND) || ture,
